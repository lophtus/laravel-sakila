    ...
    <CCardBody>
      ...
      >
        ...
        <div class="d-grid gap-1 d-md-flex justify-content-md-start mt-2">
          ...
          <router-link :to="{ name: 'film-list' }" class="ms-2 mt-2">Cancel</router-link>
        </div>
      </CForm>
    </CCardBody>
  </CCard>
...
const onSubmit = (evt: Event) => {
  ...
  const promise = axios.post("/films", formData.value);
  ...
  promise
    .then(({ data }) => {
      ...
      toastSuccess("Film was created successfully");
