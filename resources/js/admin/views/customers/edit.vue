      ...
      <template v-else>
        ...
        >
          <CFormInput
            ...
            id="inputFirstName"
            label="First Name"
            :feedbackInvalid="errorMessage('first_name')"
          ...
          <CFormInput
            ...
            id="inputLastName"
            label="Last Name"
            :feedbackInvalid="errorMessage('last_name')"
          ...
          <CFormInput
            ...
            id="inputEmail"
            label="Email"
            :feedbackInvalid="errorMessage('email')"
            :invalid="hasErrors('email')"
          />
          ...
          <div class="d-grid gap-1 d-md-flex justify-content-md-start mt-2">
            ...
            <router-link :to="{ name: 'customer-view', params: { id: props.id }}" class="ms-2 mt-2">Cancel</router-link>
          </div>
        </CForm>
      </template>
    </CCardBody>
...
const onSubmit = (evt: Event) => {
  ...
  const promise = axios.patch("/customers/" + props.id, formData.value);
  ...
  promise
    .then(({ data }) => {
      ...
      toastSuccess("Customer was updated successfully");
